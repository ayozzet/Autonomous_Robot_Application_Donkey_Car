...
import cv2
import math
#from adafruit_servokit import ServoKit    #using PCA9685 servo driver

#channel[0] for ESC, channel[1] for Servo
#kit = ServoKit(channels=16)

#pixel columns n rows (this project using 640 x 480 camera)
lineCY = 220    #rows (horizontal half of the camera captured)
lineCX = 320    #column (vertical half of the camera captured)
